...
enum class ExchangeStatusColors(val status: ExchangeStatus, val color: Int) {
    ...
    STATUS_3(ExchangeStatus.CONFIRMING, R.color.brand_color_accent_3),
    STATUS_4(ExchangeStatus.EXCHANGING, R.color.brand_color_dark_blue),
    STATUS_5(ExchangeStatus.SENDING, R.color.warning_color),
