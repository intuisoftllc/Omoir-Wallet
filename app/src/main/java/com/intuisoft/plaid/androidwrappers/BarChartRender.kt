...
class BarChartRender(
    ...
    override fun preDraw(configuration: ChartConfiguration): Boolean {
        ...
        val scaleStep = chartConfiguration.scale.size / 3
        yLabels = List(3 + 1) {
        ...
        val paddings = MeasureBarChartPaddings()(
            ...
            labelsHeight = painter.measureLabelHeight(chartConfiguration.labelsSize) * 2,
            longestLabelWidth = longestChartLabelWidth,
            labelsPaddingToInnerChart = 15f
        )
    ...
    private fun placeLabelsY(innerFrame: Frame) {
        ...
        val heightBetweenLabels =
            (innerFrame.bottom - innerFrame.top) / 3
