...
class TransactionCreator(
    ...
    @Throws
    fun create(unspentOutputs: List<UnspentOutput>, value: Long, toAddress: String, feeRate: Int, sortType: TransactionDataSortType, createOnly: Boolean): FullTransaction {
        if(createOnly)
